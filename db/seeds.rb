...
Book.where(title: 'The Cat in The Hat').first_or_create!(isbn: '978-0394800011', author: 'Dr.Seuss', genre:'Children Book', abstract:'Poor Dick and Sally. It is cold and wet and they are stuck in the house with nothing to do . . . until a giant cat in a hat shows up, transforming the dull day into a madcap adventure and almost wrecking the place in the process! Written by Dr. Seuss in 1957 in response to the concern that "pallid primers [with] abnormally courteous, unnaturally clean boys and girls were leading to growing illiteracy among children, The Cat in the Hat (the first Random House Beginner Book) changed the way our children learn how to read.', image_cover_url: 'http://ecx.images-amazon.com/images/I/517qxR55yML._SL500_PIsitb-sticker-arrow-big,TopRight,35,-73_OU01_SS100_.jpg')

Book.where(title: 'The Lorax').first_or_create!(isbn: '978-0394800011', author: 'Dr.Seuss', genre:'Children Book', abstract:'Long before saving the earth became a global concern, Dr. Seuss, speaking through his character the Lorax, warned against mindless progress and the danger it posed to the earth is natural beauty. ' , image_cover_url: 'http://ecx.images-amazon.com/images/I/51SM5e%2BY7KL._SL500_PIsitb-sticker-arrow-big,TopRight,35,-73_OU01_SS100_.jpg')

Book.where(title: 'Fox in Socks').first_or_create!(isbn: '978-0394800387', author: 'Dr.Seuss', genre:'Children Book', abstract: 'This Fox is a tricky fox. He'll try to get your tongue in trouble." Dr. Seuss gives fair warning to anyone brave enough to read along with the Fox in Socks, who likes to play tongue-twisting games with his friend Mr. Knox. Here is an easy game to play. Here's an easy thing to say.... New socks. Two socks. Whose socks? Sue's socks. But Mr. Fox Socks isn't about to let Knox off so easy. Soon Goo-Goose is choosing to chew chewy gluey blue goo, while tweetle beetles battle with paddles in a puddle (in case you were wondering, that's called a tweetle beetle puddle paddle battle.' , image_cover_url: 'http://ecx.images-amazon.com/images/I/51X3F7GQGXL._SL500_PIsitb-sticker-arrow-big,TopRight,35,-73_OU01_SS100_.jpg')
